...
/** \brief Interface de usuario para alta de cliente.
*
* \param list Cliente*
* \param len int
	...
	if(list!=NULL && len > 0)
	{
		...
		do
		{
			...
			case 2:
				...
				break;
			case 3:
				if(cliente_BuscarPorCuit(list, len, buffer.cuit)!= -1)
				{
					printf("Error el cuit ya existe\n");
					step--;
				}
				else
				{
			...
			case 5:
				...
				break;
			case 6:
				id = cliente_AltaPorId(list, len, buffer);
				if(id >= 0) {
...
/** \brief Interface de usuario para modificaion de cliente.
*
* \param list Cliente*
* \param len int
* \return int Retorna (-1) si Error [longitud invalida o
...
/** \brief Interface de usuario para baja de cliente.
*
* \param list Cliente*
* \param len int
* \return int Retorna (-1) si Error [longitud invalida o
...
/** \brief Interface de usuario para alta de Pedido.
*
* \param list Pedido*
* \param len int
** \param list2 Cliente*
...
/** \brief Interface de usuario para modificaion de Pedido.
*
* \param list Pedido*
* \param len int
* \return int Retorna (-1) si Error [longitud invalida o
		...
		else
		{
			do{
				...
				case 3:
					...
					break;
				case 9:
					if(buffer.cantidad < buffer.claseA + buffer.claseB + buffer.claseC){
						printf("La suma de los plasticos no puede ser superior a la cantidad total\n");
					}
					else
					{
